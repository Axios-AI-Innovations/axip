/**
 * Agent Gamma — Simplified Router
 *
 * Single-tier passthrough to local Ollama.
 * Only uses qwen3:1.7b for ultra-fast classification and routing.
 * No Anthropic, no budget gating, no tier system.
 ...
 */
export async function complete({ prompt, system = '', taskName, maxTokens = 512, temperature = 0.7 }) {

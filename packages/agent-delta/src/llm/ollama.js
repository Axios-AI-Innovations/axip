/**
 * Agent Delta (Sentinel) — Ollama Provider
 *
 * Local LLM inference via Ollama HTTP API.
 * Near-copy of ~/agent-beta/src/llm/ollama.js.
 * Cost: $0 per call. Still logged for usage analytics.
 *
 * Delta uses qwen3:1.7b (fast, lightweight) for sentinel analysis.
 * Qwen3 requires: think: false (disable thinking mode) and
 * options.num_predict for max tokens.
 */
